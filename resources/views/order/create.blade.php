...
<form id="order_create_form" class="validation">
    ...
    <div class="form-group row" id="quantity_div" style="display: none;">
        <label for="example-text-input" class="col-md-2 col-form-label">Quantity*</label>
        <div class="col-md-10">
            <input type="number" name="quantity" id="quantity" class="form-control" required min="1">
            <input type="hidden" name="per_price" id="per_price">
        </div>
    </div>
    ...
    <div class="form-group row">
        ...
        <div class="col-md-10">
            <input type="hidden" name="total_price" id="total_price" class="form-control">
            <input disabled type="text" name="total_price1" id="total_price1" class="form-control">
        </div>
    </div>
